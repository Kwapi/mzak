...
set :wp_user, "mzak" # The admin username
set :wp_email, "mzak@gmail.com" # The admin email address
set :wp_sitename, "Michal Zak" # The site title
set :wp_localurl, "http://mzak.dev" # Your local environment URL
